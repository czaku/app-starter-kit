...
generated=(
  "ios/AppStarterKit/DesignSystem/Tokens/AppTokens.swift"
  "ios/AppStarterKit/Core/FeatureFlags.swift"
  "ios/AppStarterKit/Core/Models/Models.swift"
  "ios/AppStarterKit/Core/Network/APIClientProtocol.swift"
